...
public class ReforgeDeserializer implements JsonDeserializer<Reforge> {
    ...
    public Reforge deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) {
        ...
        return new Reforge(obj.get("name").getAsString(), Reforge.ABILITIES.get(obj.get("ability").getAsString()),
                get(obj, "maxHealth"), get(obj, "knockbackResistance"), get(obj, "movementSpeed"),
                get(obj, "attackDamage"), get(obj, "armor"), get(obj, "armorToughness"),
                get(obj, "attackSpeed"), get(obj, "attackKnockback"), (int) get(obj, "weight"));
    }
